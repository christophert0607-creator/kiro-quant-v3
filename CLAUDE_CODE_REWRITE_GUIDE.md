...
> 最後更新：2026-05-29 HKT（kiro-pr-health-merge-loop scheduled auto-run）
>
...
| 檢查項 | 狀態 | 備註 |
|--------|------|------|
| OpenClaw Gateway | ✅ 運行中 | PID 596，~49h uptime |
| Dashboard 3000 | ✅ 開放（next-server） | next-server (v14) on port 3000 |
| state.json / config.json | ✅ 合法 JSON | |
| graphify-out/GRAPH_REPORT.md | ⚠️ 未生成 | 需檢查 graphify cron 是否正常 |
...
> **Worktree 清理（2026-05-29）**： 可清理以下 prunable worktrees：
> - /tmp/kiro-fix-exec-sm (62fa904), /tmp/kiro-fix-hk-acc (10efce5), /tmp/kiro-fix-runtime-lock (11eefa2)
> - /tmp/kiro-fix-state-store (ff13486), /tmp/kiro-pr97 (e67a2ad)
> - /tmp/kiro-refactor-mctx (e7660f1), /tmp/kiro-refactor-mds (68ace4b), /tmp/kiro-refactor-obs (8cbd5d4), /tmp/kiro-refactor-risk (1c4ad90)
> 當前 main branch worktree (`/home/tsukii0607/.openclaw/workspace-quant/kiro-quant-v3` @ ea94592) 正常運行，勿動。
...
*Generated by kiro-pr-health-merge-loop scheduled auto-run — 2026-05-29*
